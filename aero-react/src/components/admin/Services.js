          ...
          >
            <Grid container className={classes.root}>
              <Grid item xs={10} className={classes.grid__items}>
                ...
                <InputLabel id="selectServiceTypeLabel">
                  Service Type
                </InputLabel>
                <Select
                  labelId="selectServiceTypeLabel"
                  id="type"
                  name="type"
                  value={services.type || ""}
                  ...
                  autoFocus
                >
                  <MenuItem value="tune">Tune-Up</MenuItem>
                  <MenuItem value="short">Quick Service</MenuItem>
                  <MenuItem value="install">Installation</MenuItem>
                  <MenuItem value="buildBox">Build or Box</MenuItem>
                </Select>
                {/* <TextField
                    id="type"
                    name="type"
